...
<title>Seus ingressos para a Galeria Uffizi</title>
</head>
...
<tr><td style="padding:0 40px 8px; text-align:center;">
  <h2 style="margin:0; font-family:'Georgia','Times New Roman',serif; font-size:24px; font-weight:400; color:#1F2937;">Seus ingressos para a Galeria Uffizi</h2>
</td></tr>
...
<tr><td style="padding:8px 40px 28px;">
  ...
  <p style="margin:12px 0 0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:15px; color:#4B5563; line-height:1.6;">
    Obrigado por escolher Florence with Locals. Em anexo você encontrará seus ingressos para a Galeria Uffizi.
  </p>
</td></tr>
...
<tr><td style="padding:0 40px 24px;">
  <h3 style="margin:0 0 10px; font-family:'Georgia','Times New Roman',serif; font-size:17px; font-weight:400; color:#1F2937;">Instruções de entrada</h3>
  <p style="margin:0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:14px; color:#4B5563; line-height:1.65;">
    Dirija-se diretamente à Porta 01 da Galeria Uffizi. Apresente seu ingresso PDF ao funcionário e prossiga pelo controle de segurança. Não é necessário encontrar um representante ou retirar ingressos físicos — seu ingresso PDF anexo pode ser exibido diretamente no seu dispositivo móvel.
  </p>
</td></tr>
...
<tr><td style="padding:0 40px 24px;">
  ...
  <tr><td style="padding:16px 20px;">
    <h3 style="margin:0 0 8px; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:14px; font-weight:600; color:#92400E;">⚠️ Informações importantes</h3>
    <p style="margin:0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:13px; color:#78350F; line-height:1.6;">
      Recomendamos chegar à Porta 01 pelo menos <strong>15 minutos antes</strong> do horário de entrada programado. Embora seus ingressos concedam entrada prioritária (pulando a fila de compra), todos os visitantes devem passar pelo controle de segurança, o que pode causar espera.
    </p>
  </td></tr>
  </table>
</td></tr>
...
<tr><td style="padding:0 40px 24px; text-align:center;">
  <h3 style="margin:0 0 6px; font-family:'Georgia','Times New Roman',serif; font-size:17px; font-weight:400; color:#1F2937;">Enriqueça sua visita</h3>
  <p style="margin:0 0 16px; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:14px; color:#4B5563; line-height:1.6;">
    Para aproveitar ao máximo sua experiência, convidamos você a explorar nosso guia online. Este recurso interativo inclui uma história completa da Galeria Uffizi, junto com informações detalhadas sobre as obras-primas localizadas no primeiro e segundo andares.
  </p>
...
<tr><td style="padding:0 40px 24px;">
  ...
  <tr><td style="padding:16px 20px;">
    <h3 style="margin:0 0 10px; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:14px; font-weight:600; color:#1F2937;">📋 Observe</h3>
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr>
        ...
        <td style="padding:4px 0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:13px; color:#4B5563; line-height:1.5;">Esta reserva não inclui um guia físico.</td>
      </tr>
      <tr>
        <td style="padding:4px 0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:13px; color:#4B5563; vertical-align:top;">•</td>
        <td style="padding:4px 0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:13px; color:#4B5563; line-height:1.5;">Os ingressos da Galeria Uffizi são <strong>nominativos</strong>. Por favor, traga um documento de identidade válido que corresponda ao nome no seu ingresso, pois o museu pode recusar a entrada se os dados não corresponderem.</td>
      </tr>
    </table>
  </td></tr>
  </table>
