...
<title>Tus entradas para la Galería Uffizi</title>
</head>
...
<tr><td style="padding:0 40px 8px; text-align:center;">
  <h2 style="margin:0; font-family:'Georgia','Times New Roman',serif; font-size:24px; font-weight:400; color:#1F2937;">Tus entradas para la Galería Uffizi</h2>
</td></tr>
...
<tr><td style="padding:0 40px 24px;">
  <h3 style="margin:0 0 10px; font-family:'Georgia','Times New Roman',serif; font-size:17px; font-weight:400; color:#1F2937;">Instrucciones de entrada</h3>
  <p style="margin:0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:14px; color:#4B5563; line-height:1.65;">
    Dirígete directamente a la Puerta 01 de la Galería Uffizi. Muestra tu entrada PDF al personal y continúa a través del control de seguridad. No es necesario encontrarse con un representante ni recoger entradas físicas — tu entrada PDF adjunta puede mostrarse directamente desde tu dispositivo móvil.
  </p>
</td></tr>
...
<tr><td style="padding:0 40px 24px;">
  ...
  <tr><td style="padding:16px 20px;">
    <h3 style="margin:0 0 8px; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:14px; font-weight:600; color:#92400E;">⚠️ Información importante</h3>
    <p style="margin:0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:13px; color:#78350F; line-height:1.6;">
      Recomendamos llegar a la Puerta 01 al menos <strong>15 minutos antes</strong> de la hora de entrada programada. Aunque tus entradas te dan acceso prioritario (saltando la fila de compra), todos los visitantes deben pasar por el control de seguridad, lo que puede ocasionar esperas.
    </p>
  </td></tr>
  </table>
</td></tr>
...
<tr><td style="padding:0 40px 24px; text-align:center;">
  <h3 style="margin:0 0 6px; font-family:'Georgia','Times New Roman',serif; font-size:17px; font-weight:400; color:#1F2937;">Mejora tu visita</h3>
  <p style="margin:0 0 16px; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:14px; color:#4B5563; line-height:1.6;">
    Para aprovechar al máximo tu experiencia, te invitamos a explorar nuestra guía online. Este recurso interactivo incluye una historia completa de la Galería Uffizi, junto con información detallada sobre las obras maestras ubicadas en la primera y segunda planta.
  </p>
...
<tr><td style="padding:0 40px 24px;">
  ...
  <tr><td style="padding:16px 20px;">
    <h3 style="margin:0 0 10px; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:14px; font-weight:600; color:#1F2937;">📋 Ten en cuenta</h3>
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr>
        ...
        <td style="padding:4px 0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:13px; color:#4B5563; line-height:1.5;">Esta reserva no incluye un guía físico.</td>
      </tr>
      <tr>
        <td style="padding:4px 0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:13px; color:#4B5563; vertical-align:top;">•</td>
        <td style="padding:4px 0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:13px; color:#4B5563; line-height:1.5;">Las entradas de la Galería Uffizi son <strong>nominativas</strong>. Por favor, trae un documento de identidad válido que coincida con el nombre en tu entrada, ya que el museo puede denegar el acceso si los datos no coinciden.</td>
      </tr>
    </table>
  </td></tr>
  </table>
