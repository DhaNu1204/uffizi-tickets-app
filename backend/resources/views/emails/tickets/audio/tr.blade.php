...
<title>Uffizi Galerisi Biletleriniz + Sesli Rehber</title>
</head>
...
<tr><td style="padding:0 40px 8px; text-align:center;">
  <h2 style="margin:0; font-family:'Georgia','Times New Roman',serif; font-size:24px; font-weight:400; color:#1F2937;">Biletleriniz + Sesli Rehber</h2>
</td></tr>
...
<tr><td style="padding:8px 40px 28px;">
  ...
  <p style="margin:12px 0 0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:15px; color:#4B5563; line-height:1.6;">
    Florence with Locals'ı tercih ettiğiniz için teşekkür ederiz. Uffizi Galerisi biletleriniz ve sesli rehber erişiminiz ekte yer almaktadır.
  </p>
</td></tr>
...
<tr><td style="padding:0 40px 24px;">
  ...
  <tr><td style="padding:28px 30px; text-align:center;">
    ...
    <h3 style="margin:0 0 8px; font-family:'Georgia','Times New Roman',serif; font-size:20px; font-weight:400; color:#FFFFFF;">Sesli Rehber Kurulum Talimatları</h3>
    <p style="margin:0 0 20px; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:14px; color:#C4B5FD; line-height:1.6;">
      PopGuide uygulamasını indirmek ve sesli rehberinizi etkinleştirmek için aşağıdaki düğmeye dokunun. Bağlantı otomatik olarak erişiminizi ayarlayacaktır — kullanıcı adı veya şifre gerekmez.
    </p>
    ...
    <p style="margin:16px 0 0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:12px; color:#A5B4FC; line-height:1.5;">
      Kurulumdan sonra sesli rehber çevrimdışı kullanılabilir. Bu adımı ziyaretinizden önce tamamlamanızı öneririz.
    </p>
  </td></tr>
  </table>
</td></tr>
...
<tr><td style="padding:0 40px 24px;">
  ...
  <tr><td style="padding:16px 20px;">
    <h3 style="margin:0 0 8px; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:14px; font-weight:600; color:#92400E;">⚠️ Önemli hatırlatmalar</h3>
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr><td style="padding:4px 0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:13px; color:#78350F;">⏰ <strong>15 dakika erken</strong> gelin — güvenlik kontrolleri gecikmelere neden olabilir</td></tr>
      <tr><td style="padding:4px 0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:13px; color:#78350F;">🪪 Biletteki isimle eşleşen <strong>geçerli kimlik</strong> getirin</td></tr>
      <tr><td style="padding:4px 0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:13px; color:#78350F;">📱 Kapı 01'deki personele <strong>PDF biletinizi</strong> gösterin</td></tr>
      <tr><td style="padding:4px 0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:13px; color:#78350F;">🎧 Sesli rehber için kendi <strong>kulaklığınızı</strong> getirin</td></tr>
    </table>
  </td></tr>
  </table>
</td></tr>
