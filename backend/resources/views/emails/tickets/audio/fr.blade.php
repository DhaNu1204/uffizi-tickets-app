...
<title>Vos billets + Audioguide pour la Galerie des Offices</title>
</head>
...
<tr><td style="padding:0 40px 8px; text-align:center;">
  <h2 style="margin:0; font-family:'Georgia','Times New Roman',serif; font-size:24px; font-weight:400; color:#1F2937;">Vos billets + Audioguide</h2>
</td></tr>
...
<tr><td style="padding:8px 40px 28px;">
  ...
  <p style="margin:12px 0 0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:15px; color:#4B5563; line-height:1.6;">
    Merci d'avoir choisi Florence with Locals. Vous trouverez ci-joint vos billets pour la Galerie des Offices ainsi que votre accès à l'audioguide.
  </p>
</td></tr>
...
<tr><td style="padding:0 40px 28px;">
  ...
  <tr><td style="padding:28px 30px; text-align:center;">
    ...
    <h3 style="margin:0 0 8px; font-family:'Georgia','Times New Roman',serif; font-size:20px; font-weight:400; color:#FFFFFF;">Audioguide Inclus !</h3>
    <p style="margin:0 0 20px; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:14px; color:#DDD6FE; line-height:1.5;">
      Appuyez sur le bouton ci-dessous pour activer votre expérience audio PopGuide
    </p>
    ...
    <p style="margin:16px 0 0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:12px; color:#A5B4FC;">
      Téléchargez l'app "PopGuide" si demandé • Apportez vos propres écouteurs
    </p>
  </td></tr>
  </table>
</td></tr>
...
<tr><td style="padding:0 40px 24px;">
  ...
  <tr><td style="padding:16px 20px;">
    <h3 style="margin:0 0 8px; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:14px; font-weight:600; color:#92400E;">⚠️ Rappels importants</h3>
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr><td style="padding:4px 0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:13px; color:#78350F;">⏰ Arrivez <strong>15 minutes en avance</strong> — les contrôles de sécurité peuvent causer des retards</td></tr>
      <tr><td style="padding:4px 0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:13px; color:#78350F;">🪪 Apportez une <strong>pièce d'identité valide</strong> correspondant au nom sur le billet</td></tr>
      <tr><td style="padding:4px 0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:13px; color:#78350F;">📱 Montrez votre <strong>billet PDF</strong> au personnel à la Porte 01</td></tr>
      <tr><td style="padding:4px 0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:13px; color:#78350F;">🎧 Apportez vos propres <strong>écouteurs</strong> pour l'audioguide</td></tr>
    </table>
  </td></tr>
  </table>
</td></tr>
