...
<title>ウフィツィ美術館のチケット + オーディオガイド</title>
</head>
...
<tr><td style="padding:0 40px 8px; text-align:center;">
  <h2 style="margin:0; font-family:'Georgia','Times New Roman',serif; font-size:24px; font-weight:400; color:#1F2937;">チケット + オーディオガイド</h2>
</td></tr>
...
<tr><td style="padding:8px 40px 28px;">
  ...
  <p style="margin:12px 0 0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:15px; color:#4B5563; line-height:1.6;">
    Florence with Localsをお選びいただきありがとうございます。ウフィツィ美術館のチケットとオーディオガイドのアクセス情報を添付しております。
  </p>
</td></tr>
...
<tr><td style="padding:0 40px 28px;">
  ...
  <tr><td style="padding:28px 30px; text-align:center;">
    ...
    <h3 style="margin:0 0 8px; font-family:'Georgia','Times New Roman',serif; font-size:20px; font-weight:400; color:#FFFFFF;">オーディオガイド付き！</h3>
    <p style="margin:0 0 20px; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:14px; color:#DDD6FE; line-height:1.5;">
      下のボタンをタップして、PopGuideオーディオ体験を有効にしてください
    </p>
    ...
    <p style="margin:16px 0 0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:12px; color:#A5B4FC;">
      求められた場合は「PopGuide」アプリをダウンロードしてください • ヘッドフォンをお持ちください
    </p>
  </td></tr>
  </table>
</td></tr>
...
<tr><td style="padding:0 40px 24px;">
  ...
  <tr><td style="padding:16px 20px;">
    <h3 style="margin:0 0 8px; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:14px; font-weight:600; color:#92400E;">⚠️ 重要なお知らせ</h3>
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr><td style="padding:4px 0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:13px; color:#78350F;">⏰ <strong>15分前</strong>にお越しください — セキュリティチェックで遅延する場合があります</td></tr>
      <tr><td style="padding:4px 0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:13px; color:#78350F;">🪪 チケットの名前と一致する<strong>有効な身分証明書</strong>をお持ちください</td></tr>
      <tr><td style="padding:4px 0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:13px; color:#78350F;">📱 ドア01のスタッフに<strong>PDFチケット</strong>をご提示ください</td></tr>
      <tr><td style="padding:4px 0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:13px; color:#78350F;">🎧 オーディオガイド用の<strong>ヘッドフォン</strong>をお持ちください</td></tr>
    </table>
  </td></tr>
  </table>
</td></tr>
