          ...
          <div className={`user-menu ${menuOpen ? 'open' : ''}`}>
            ...
            {menuOpen && (
              <div className="dropdown-menu">
                ...
                <button onClick={() => { setMenuOpen(false); navigate('/conversations'); }} className="dropdown-item">
                ...
                <button onClick={() => { setMenuOpen(false); navigate('/messages'); }} className="dropdown-item">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
